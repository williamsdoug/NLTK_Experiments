# Borrowed clustering routines from below source.  Clustering based on TF-IDF - Term Frequency - Inverse Document Frequency
#    Source: http://stackoverflow.com/questions/1789254/clustering-text-in-python
#
# For more information on TF-IDF, see: http://en.wikipedia.org/wiki/Tf–idf
